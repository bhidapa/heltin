...
export const CaseHistoryIndividualTypeSelectOptions: React.FC<CaseHistoryIndividualTypeSelectOptionsProps> = React.memo(
  function CaseHistoryIndividualTypeSelectOptions({ disableEmptyOption }) {
    return (
      <>
