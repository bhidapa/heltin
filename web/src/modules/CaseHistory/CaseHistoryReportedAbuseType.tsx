...
export const CaseHistoryReportedAbuseTypeSelectOptions: React.FC<CaseHistoryReportedAbuseTypeSelectOptionsProps> = React.memo(
  function CaseHistoryReportedAbuseTypeSelectOptions({ disableEmptyOption }) {
    return (
      <>
