...
export const CaseHistoryAccompaniedByTypeSelectOptions: React.FC<CaseHistoryAccompaniedByTypeSelectOptionsProps> =
  React.memo(function CaseHistoryAccompaniedByTypeSelectOptions({ disableEmptyOption }) {
    return (
      <>
