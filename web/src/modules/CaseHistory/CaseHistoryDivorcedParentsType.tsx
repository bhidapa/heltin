...
export const CaseHistoryDivorcedParentsTypeSelectOptions: React.FC<CaseHistoryDivorcedParentsTypeSelectOptionsProps> =
  React.memo(function CaseHistoryDivorcedParentsTypeSelectOptions({ disableEmptyOption }) {
    return (
      <>
