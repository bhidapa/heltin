...
export const CaseHistoryLivesWithTypeSelectOptions: React.FC<CaseHistoryLivesWithTypeSelectOptionsProps> =
  React.memo(function CaseHistoryLivesWithTypeSelectOptions({ disableEmptyOption }) {
    return (
      <>
